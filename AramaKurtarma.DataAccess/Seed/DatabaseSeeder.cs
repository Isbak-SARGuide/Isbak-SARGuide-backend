...
namespace AramaKurtarma.DataAccess.Seed;
...
public static class DatabaseSeeder
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        var dbContext = services.GetRequiredService<AramaKurtarmaDbContext>();
        ...
        IConfiguration configuration)
    {
        ...
        {
            UserName = userName,
            Email = $"{userName}@arama-kurtarma.local",
            EmailConfirmed = true,
    ...
    private static async Task SeedContentTreeAsync(AramaKurtarmaDbContext dbContext)
    {
